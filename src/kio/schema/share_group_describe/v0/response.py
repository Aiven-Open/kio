"""
Generated from ``clients/src/main/resources/common/message/ShareGroupDescribeResponse.json``.
"""
...
class TopicPartitions:
    ...
    __api_key__: ClassVar[i16] = i16(77)
...
@dataclass(frozen=True, slots=True, kw_only=True)
class ShareGroupDescribeResponse:
