"""
Generated from ``clients/src/main/resources/common/message/DeleteShareGroupStateRequest.json``.
"""
...
@dataclass(frozen=True, slots=True, kw_only=True)
class DeleteShareGroupStateRequest:
