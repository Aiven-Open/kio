"""
Generated from ``clients/src/main/resources/common/message/DeleteShareGroupOffsetsResponse.json``.
"""
...
class DeleteShareGroupOffsetsResponseTopic:
...
@dataclass(frozen=True, slots=True, kw_only=True)
class DeleteShareGroupOffsetsResponse:
    ...
    responses: tuple[DeleteShareGroupOffsetsResponseTopic, ...]
