...
https://github.com/apache/kafka/tree/3.5.1/clients/src/main/resources/common/message/DescribeDelegationTokenResponse.json
"""
...
class DescribedDelegationToken:
    ...
    token_requester_principal_type: str = field(metadata={"kafka_type": "string"})
    """The principal type of the requester of the token."""
    token_requester_principal_name: str = field(metadata={"kafka_type": "string"})
    """The principal type of the requester of the token."""
