...
class DescribeLogDirsPartition:
    ...
    """The partition index."""
    partition_size: int = field(metadata={"kafka_type": "int64"})
    """The size of the log segments in this partition in bytes."""
    offset_lag: int = field(metadata={"kafka_type": "int64"})
...
class DescribeLogDirsResult:
    ...
    """Each topic."""
    total_bytes: int = field(metadata={"kafka_type": "int64"}, default=-1)
    """The total size in bytes of the volume the log directory is in."""
    usable_bytes: int = field(metadata={"kafka_type": "int64"}, default=-1)
