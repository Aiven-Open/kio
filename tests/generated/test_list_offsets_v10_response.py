...
from kio.schema.list_offsets.v10.response import ListOffsetsPartitionResponse
from kio.schema.list_offsets.v10.response import ListOffsetsResponse
from kio.schema.list_offsets.v10.response import ListOffsetsTopicResponse
...
def test_list_offsets_partition_response_roundtrip(
    ...
    with setup_buffer() as buffer:
        ...
        result, _ = read_list_offsets_partition_response(
            buffer.getvalue(),
            0,
        )
...
def test_list_offsets_topic_response_roundtrip(
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_list_offsets_topic_response(
            buffer.getvalue(),
            0,
        )
...
def test_list_offsets_response_roundtrip(instance: ListOffsetsResponse) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_list_offsets_response(
            buffer.getvalue(),
            0,
        )
