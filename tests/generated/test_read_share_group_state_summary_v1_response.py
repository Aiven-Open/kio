...
from kio.schema.read_share_group_state_summary.v1.response import PartitionResult
from kio.schema.read_share_group_state_summary.v1.response import (
    ReadShareGroupStateSummaryResponse,
)
from kio.schema.read_share_group_state_summary.v1.response import ReadStateSummaryResult
