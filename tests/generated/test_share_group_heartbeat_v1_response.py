...
from kio.schema.share_group_heartbeat.v1.response import Assignment
from kio.schema.share_group_heartbeat.v1.response import ShareGroupHeartbeatResponse
from kio.schema.share_group_heartbeat.v1.response import TopicPartitions
...
def test_share_group_heartbeat_response_roundtrip(
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_share_group_heartbeat_response(
            buffer.getvalue(),
            0,
        )
