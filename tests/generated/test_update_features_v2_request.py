...
from kio.schema.update_features.v2.request import FeatureUpdateKey
from kio.schema.update_features.v2.request import UpdateFeaturesRequest
...
def test_feature_update_key_roundtrip(instance: FeatureUpdateKey) -> None:
    ...
    with setup_buffer() as buffer:
        ...
        result, _ = read_feature_update_key(
            buffer.getvalue(),
            0,
        )
...
def test_update_features_request_roundtrip(instance: UpdateFeaturesRequest) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_update_features_request(
            buffer.getvalue(),
            0,
        )
