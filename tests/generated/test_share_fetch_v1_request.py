...
from kio.schema.share_fetch.v1.request import AcknowledgementBatch
from kio.schema.share_fetch.v1.request import FetchPartition
from kio.schema.share_fetch.v1.request import FetchTopic
from kio.schema.share_fetch.v1.request import ForgottenTopic
from kio.schema.share_fetch.v1.request import ShareFetchRequest
...
def test_share_fetch_request_roundtrip(instance: ShareFetchRequest) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_share_fetch_request(
            buffer.getvalue(),
            0,
        )
