...
from kio.schema.broker_registration.v4.request import BrokerRegistrationRequest
from kio.schema.broker_registration.v4.request import Feature
from kio.schema.broker_registration.v4.request import Listener
...
def test_broker_registration_request_roundtrip(
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_broker_registration_request(
            buffer.getvalue(),
            0,
        )
