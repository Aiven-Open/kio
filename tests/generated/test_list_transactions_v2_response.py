...
from kio.schema.list_transactions.v2.response import ListTransactionsResponse
from kio.schema.list_transactions.v2.response import TransactionState
...
def test_transaction_state_roundtrip(instance: TransactionState) -> None:
    ...
    with setup_buffer() as buffer:
        ...
        result, _ = read_transaction_state(
            buffer.getvalue(),
            0,
        )
...
def test_list_transactions_response_roundtrip(
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_list_transactions_response(
            buffer.getvalue(),
            0,
        )
