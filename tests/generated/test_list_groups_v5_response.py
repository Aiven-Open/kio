...
from kio.schema.list_groups.v5.response import ListedGroup
from kio.schema.list_groups.v5.response import ListGroupsResponse
...
def test_list_groups_response_roundtrip(instance: ListGroupsResponse) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_list_groups_response(
            buffer.getvalue(),
            0,
        )
