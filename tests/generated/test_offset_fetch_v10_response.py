...
from kio.schema.offset_fetch.v10.response import OffsetFetchResponse
from kio.schema.offset_fetch.v10.response import OffsetFetchResponseGroup
from kio.schema.offset_fetch.v10.response import OffsetFetchResponsePartitions
from kio.schema.offset_fetch.v10.response import OffsetFetchResponseTopics
...
def test_offset_fetch_response_partitions_roundtrip(
    ...
    with setup_buffer() as buffer:
        ...
        result, _ = read_offset_fetch_response_partitions(
            buffer.getvalue(),
            0,
        )
...
def test_offset_fetch_response_topics_roundtrip(
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_offset_fetch_response_topics(
            buffer.getvalue(),
            0,
        )
...
def test_offset_fetch_response_group_roundtrip(
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_offset_fetch_response_group(
            buffer.getvalue(),
            0,
        )
...
def test_offset_fetch_response_roundtrip(instance: OffsetFetchResponse) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_offset_fetch_response(
            buffer.getvalue(),
            0,
        )
