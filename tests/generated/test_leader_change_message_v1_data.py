...
from kio.schema.leader_change_message.v1.data import LeaderChangeMessage
from kio.schema.leader_change_message.v1.data import Voter
...
def test_leader_change_message_roundtrip(instance: LeaderChangeMessage) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_leader_change_message(
            buffer.getvalue(),
            0,
        )
