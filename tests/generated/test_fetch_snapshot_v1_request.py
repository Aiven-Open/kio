...
from kio.schema.fetch_snapshot.v1.request import FetchSnapshotRequest
from kio.schema.fetch_snapshot.v1.request import PartitionSnapshot
from kio.schema.fetch_snapshot.v1.request import SnapshotId
from kio.schema.fetch_snapshot.v1.request import TopicSnapshot
...
def test_fetch_snapshot_request_roundtrip(instance: FetchSnapshotRequest) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_fetch_snapshot_request(
            buffer.getvalue(),
            0,
        )
