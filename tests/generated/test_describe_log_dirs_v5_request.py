...
from kio.schema.describe_log_dirs.v5.request import DescribableLogDirTopic
from kio.schema.describe_log_dirs.v5.request import DescribeLogDirsRequest
...
def test_describable_log_dir_topic_roundtrip(instance: DescribableLogDirTopic) -> None:
    ...
    with setup_buffer() as buffer:
        ...
        result, _ = read_describable_log_dir_topic(
            buffer.getvalue(),
            0,
        )
...
def test_describe_log_dirs_request_roundtrip(instance: DescribeLogDirsRequest) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_describe_log_dirs_request(
            buffer.getvalue(),
            0,
        )
