...
from kio.schema.share_group_describe.v1.response import Assignment
from kio.schema.share_group_describe.v1.response import DescribedGroup
from kio.schema.share_group_describe.v1.response import Member
from kio.schema.share_group_describe.v1.response import ShareGroupDescribeResponse
from kio.schema.share_group_describe.v1.response import TopicPartitions
...
def test_share_group_describe_response_roundtrip(
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_share_group_describe_response(
            buffer.getvalue(),
            0,
        )
