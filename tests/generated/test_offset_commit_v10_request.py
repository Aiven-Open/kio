...
from kio.schema.offset_commit.v10.request import OffsetCommitRequest
from kio.schema.offset_commit.v10.request import OffsetCommitRequestPartition
from kio.schema.offset_commit.v10.request import OffsetCommitRequestTopic
...
def test_offset_commit_request_partition_roundtrip(
    ...
    with setup_buffer() as buffer:
        ...
        result, _ = read_offset_commit_request_partition(
            buffer.getvalue(),
            0,
        )
...
def test_offset_commit_request_topic_roundtrip(
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_offset_commit_request_topic(
            buffer.getvalue(),
            0,
        )
...
def test_offset_commit_request_roundtrip(instance: OffsetCommitRequest) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_offset_commit_request(
            buffer.getvalue(),
            0,
        )
