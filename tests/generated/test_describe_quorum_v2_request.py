...
from kio.schema.describe_quorum.v2.request import DescribeQuorumRequest
from kio.schema.describe_quorum.v2.request import PartitionData
from kio.schema.describe_quorum.v2.request import TopicData
...
def test_describe_quorum_request_roundtrip(instance: DescribeQuorumRequest) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_describe_quorum_request(
            buffer.getvalue(),
            0,
        )
