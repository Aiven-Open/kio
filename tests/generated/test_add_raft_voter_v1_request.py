...
from kio.schema.add_raft_voter.v1.request import AddRaftVoterRequest
from kio.schema.add_raft_voter.v1.request import Listener
...
def test_add_raft_voter_request_roundtrip(instance: AddRaftVoterRequest) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_add_raft_voter_request(
            buffer.getvalue(),
            0,
        )
