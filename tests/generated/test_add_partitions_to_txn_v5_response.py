...
from kio.schema.add_partitions_to_txn.v5.response import AddPartitionsToTxnResponse
from kio.schema.add_partitions_to_txn.v5.response import AddPartitionsToTxnResult
from kio.schema.add_partitions_to_txn.v5.response import AddPartitionsToTxnTopicResult
