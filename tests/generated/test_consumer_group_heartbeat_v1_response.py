...
from kio.schema.consumer_group_heartbeat.v1.response import Assignment
from kio.schema.consumer_group_heartbeat.v1.response import (
    ConsumerGroupHeartbeatResponse,
)
from kio.schema.consumer_group_heartbeat.v1.response import TopicPartitions
...
def test_consumer_group_heartbeat_response_roundtrip(
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_consumer_group_heartbeat_response(
            buffer.getvalue(),
            0,
        )
