...
from kio.schema.list_config_resources.v0.response import ConfigResource
from kio.schema.list_config_resources.v0.response import ListConfigResourcesResponse
