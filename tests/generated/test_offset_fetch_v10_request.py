...
from kio.schema.offset_fetch.v10.request import OffsetFetchRequest
from kio.schema.offset_fetch.v10.request import OffsetFetchRequestGroup
from kio.schema.offset_fetch.v10.request import OffsetFetchRequestTopics
...
def test_offset_fetch_request_topics_roundtrip(
    ...
    with setup_buffer() as buffer:
        ...
        result, _ = read_offset_fetch_request_topics(
            buffer.getvalue(),
            0,
        )
...
def test_offset_fetch_request_group_roundtrip(
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_offset_fetch_request_group(
            buffer.getvalue(),
            0,
        )
...
def test_offset_fetch_request_roundtrip(instance: OffsetFetchRequest) -> None:
    ...
    with setup_buffer() as buffer:
        writer(buffer, instance)
        result, _ = read_offset_fetch_request(
            buffer.getvalue(),
            0,
        )
